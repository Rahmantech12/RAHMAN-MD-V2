...
const port = process.env.PORT || 9090;
  ...
  try {
    await conn.newsletterFollow("120363201214007503@newsletter");
    console.log("📬 Followed RAHMAN TECH newsletter.");
  } catch (e) {
    console.error("❌ Failed to follow newsletter:", e);
  }
  // ------------------------------

  let up = `*✨ Hello, RAHMAN-MD User! ✨*

╭─〔 *🤖RAHMAN-MD* 〕  
├─▸ *Ultrasonic, Speed and Power By Black-Tappy!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*🩷Thank you for Choosing RAHMAN-MD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   https://whatsapp.com/channel/0029VaEV2x85kg7Eid9iK43R
├─ ⭐ *Give Us a Star:*  
│   Star Us ‎https://github.com/RAHMAN-TECH90/RAHMAN-MD-V2
‎ ╰─🛠️ *Prefix:* \`${prefix}\`

> _© *Powered By Rahman Tech*_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/t3p1at.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('923015954782', '923015954782', '923319709781');
