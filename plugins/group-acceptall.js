...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        let text = `📋 *ᴘᴇɴᴅɪɴɢ ᴊᴏɪɴ ʀᴇϙᴜᴇsᴛs (${requests.length})*\n\n`;
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        return reply(`✅ᴊᴏɪɴ ʀᴇϙᴜᴇsᴛ sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴄᴇᴘᴛᴇᴅ ${requests.length} ᴊᴏɪɴ ʀᴇϙᴜᴇsᴛs.`);
    } catch (error) {
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        return reply(`ᴊᴏɪɴ ʀᴇϙᴜᴇsᴛ sᴜᴄᴄᴇssғᴜʟʟʏ ʀᴇᴊᴇᴄᴛᴇᴅ  ${requests.length} ᴊᴏɪɴ ʀᴇϙᴜᴇsᴛs.`);
    } catch (error) {
